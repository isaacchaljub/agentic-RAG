...
#     identity). Only safe because rg-demo is DEDICATED to this app. If you ever
#     point this at a shared group, delete resources individually instead.
# =============================================================================
set -uo pipefail

RG="${RG:-rg-demo}"
KV="${KV:-agenticragkv0725}"
